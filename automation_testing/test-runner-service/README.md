...
2. Configure environment variables (create a `.env` or export directly):
   ...
   | `TRIGGER_SHARED_SECRET` | Password required to use the page (Basic Auth) — leave unset only for local testing | *(none)* |
